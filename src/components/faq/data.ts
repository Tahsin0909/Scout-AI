export const faqs = [
    ...
    },
    {
        ...
        answer:
            'Standard delivery takes 3-5 business days. Express delivery is available for an additional fee and can provide results within 24-48 hours.',
    },
    {
        question: 'What if my package has an error or is missing something?',
        answer:
    ...
    },
    {
        ...
        answer:
            'Our AI is trained on extensive outdoor data and cross-references with expert sources. However, always verify critical information before your trip and consult local authorities for current conditions.',
    },
    {
        question: 'What travel modes do you support?',
        answer:
            'We support hiking, backpacking, camping, RV overlanding, car camping, mountain biking, and more. Let us know your travel style when ordering.',
    },
]